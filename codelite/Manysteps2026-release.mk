...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS :=  -O2 -W -Wall $(Preprocessors)
...
Objects0=$(IntermediateDirectory)/StackLog.cpp$(ObjectSuffix) $(IntermediateDirectory)/MixedStack.cpp$(ObjectSuffix) $(IntermediateDirectory)/Stack.cpp$(ObjectSuffix) $(IntermediateDirectory)/manysteps-unb.cc$(ObjectSuffix) $(IntermediateDirectory)/BucketedQueue.cpp$(ObjectSuffix) 
